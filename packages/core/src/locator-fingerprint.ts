 ...
 *
 * The single source of truth for both the server lookup / demo router (via
 * `#shared/locator-fingerprint`) and the reporter's runtime annotation (which
 * bundles this at build time).
 */
