...
Markers are managed through the REST API (`GET`/`POST /api/projects/:id/markers`, `PUT`/`DELETE /api/markers/:id`). See the interactive [API docs](https://piwitests.github.io/demo/docs) for request and response shapes.
