...
export const FAILURE_STORIES = [
  {
    ...
    evidence: {
      ...
      failingNetwork: [
        { method: 'POST', url: 'https://shop.example.com/api/checkout/quote', status: 200, duration: 28400, resourceType: 'fetch' },
      ],
      ...
      failingNetwork: [
        {
          ...
          serverLogs: [
            ...
            { timestamp: 1745568000010, level: 'warn', category: 'auth', message: 'verifyCredentials returned null for user@example.com' },
          ],
        },
      ],
    },
...

  {
    ...
    evidence: {
      failingNetwork: [
        { method: 'PUT', url: 'https://api.shop.example.com/orders/1001/status', status: 200, duration: 96, resourceType: 'fetch' },
      ],
    },
...

  {
    ...
    diagnosis: {
      ...
      fix: {
        description: 'Create the focus trap before activating it, so open() no longer throws on the teleported mount target.',
...

  {
    ...
    media: { screenshot: 'button-gallery-strict.png', trace: 'button-strict-mode.zip', video: 'button-strict-mode.webm' },
...

  {
    ...
    diagnosis: {
      ...
      area: 'mobile forms',
      fix: {
        description: 'Cap the signature-pad backing store to the visible viewport so WebKit stops killing the page on 3× devices.',
...
export const DEMO_PROJECTS = [
  {
    ...
    cases: [
      { file: 'tests/checkout/checkout.spec.ts', title: 'should complete checkout with credit card', declLine: decl(CHECKOUT_SPEC, 'should complete checkout with credit card'), declColumn: 3 },
      { file: 'tests/checkout/checkout.spec.ts', title: 'should complete checkout with PayPal', declLine: decl(CHECKOUT_SPEC, 'should complete checkout with PayPal'), declColumn: 3 },
      { file: 'tests/checkout/checkout.spec.ts', title: 'should complete checkout with Apple Pay', declLine: decl(CHECKOUT_SPEC, 'should complete checkout with Apple Pay'), declColumn: 3 },
      { file: 'tests/checkout/checkout.spec.ts', title: 'should show error for expired card', declLine: decl(CHECKOUT_SPEC, 'should show error for expired card'), declColumn: 3 },
      { file: 'tests/checkout/checkout.spec.ts', title: 'should show error for invalid CVV', declLine: decl(CHECKOUT_SPEC, 'should show error for invalid CVV'), declColumn: 3 },
      ...
      { file: 'tests/checkout/cart.spec.ts', title: 'should display cart total correctly', declLine: 33, declColumn: 3 },
      { file: 'tests/checkout/address.spec.ts', title: 'should fill and save shipping address', declLine: 4, declColumn: 3 },
      { file: 'tests/checkout/address.spec.ts', title: 'should validate required address fields', declLine: 13, declColumn: 3 },
    ],
    suites: {
    ...
    browsers: [
      { projectName: 'Chromium', browserName: 'chromium', channel: null, viewport: { width: 1280, height: 720 }, ...DESKTOP, locale: 'en-US', timezoneId: 'America/New_York', colorScheme: 'light' },
      { projectName: 'Firefox', browserName: 'firefox', channel: null, viewport: { width: 1280, height: 720 }, ...DESKTOP, locale: 'en-US', timezoneId: 'America/New_York', colorScheme: 'light' },
      { projectName: 'Chrome Stable', browserName: 'chromium', channel: 'chrome', viewport: { width: 1280, height: 720 }, ...DESKTOP, locale: 'en-US', timezoneId: 'America/New_York', colorScheme: 'light' },
    ],
    ...
    network: [
      ...
      { method: 'POST', url: 'https://shop.example.com/api/checkout/quote', status: 200, duration: 240, resourceType: 'fetch' },
      { method: 'POST', url: 'https://shop.example.com/api/payments/authorize', status: 201, duration: 380, resourceType: 'fetch' },
      { method: 'GET', url: 'https://cdn.pay.example.com/sdk.js', status: 200, duration: 850, resourceType: 'script', contentType: 'text/javascript' },
    ],
    consolePassing: [
      { type: 'log', text: '[analytics] page view: /checkout', location: 'https://shop.example.com/assets/analytics-Bh2kQ9.js:1:2210' },
    ],
    webVitals: true,
    pageState: {
  ...
  },
  {
    ...
    baseUrl: null,
    cases: [
      { file: 'tests/api/auth.spec.ts', title: 'POST /auth/login returns 200 with valid credentials', declLine: decl(AUTH_SPEC, 'POST /auth/login returns 200 with valid credentials'), declColumn: 3 },
      { file: 'tests/api/auth.spec.ts', title: 'POST /auth/login returns 401 with invalid credentials', declLine: decl(AUTH_SPEC, 'POST /auth/login returns 401 with invalid credentials'), declColumn: 3 },
      { file: 'tests/api/auth.spec.ts', title: 'GET /auth/me returns current user', declLine: decl(AUTH_SPEC, 'GET /auth/me returns current user'), declColumn: 3 },
      { file: 'tests/api/products.spec.ts', title: 'GET /products returns paginated list', declLine: 4, declColumn: 3 },
      { file: 'tests/api/products.spec.ts', title: 'GET /products/:id returns product details', declLine: 11, declColumn: 3 },
      { file: 'tests/api/products.spec.ts', title: 'POST /products creates product (admin)', declLine: 18, declColumn: 3 },
      { file: 'tests/api/products.spec.ts', title: 'DELETE /products/:id removes product (admin)', declLine: 26, declColumn: 3 },
      { file: 'tests/api/orders.spec.ts', title: 'POST /orders creates order', declLine: decl(ORDERS_SPEC, 'POST /orders creates order'), declColumn: 3 },
      { file: 'tests/api/orders.spec.ts', title: 'GET /orders/:id returns order details', declLine: decl(ORDERS_SPEC, 'GET /orders/:id returns order details'), declColumn: 3 },
      { file: 'tests/api/orders.spec.ts', title: 'PUT /orders/:id/status updates order status', declLine: decl(ORDERS_SPEC, 'PUT /orders/:id/status updates order status'), declColumn: 3 },
    ...
    browserRotation: [0],
    network: [
      { method: 'POST', url: 'https://api.shop.example.com/auth/login', status: 200, duration: 120, resourceType: 'fetch' },
      { method: 'GET', url: 'https://api.shop.example.com/products?page=1', status: 200, duration: 85, resourceType: 'fetch' },
      { method: 'POST', url: 'https://api.shop.example.com/orders', status: 201, duration: 145, resourceType: 'fetch' },
      { method: 'GET', url: 'https://api.shop.example.com/orders/1001', status: 200, duration: 64, resourceType: 'fetch' },
    ],
    consolePassing: null,
    webVitals: false,
    pageState: null,
  ...
  },
  {
    ...
    cases: [
      { file: 'tests/ui/button.spec.ts', title: 'Button primary variant renders correctly', declLine: decl(BUTTON_SPEC, 'Button primary variant renders correctly'), declColumn: 3 },
      { file: 'tests/ui/button.spec.ts', title: 'Button disabled state renders correctly', declLine: decl(BUTTON_SPEC, 'Button disabled state renders correctly'), declColumn: 3 },
      { file: 'tests/ui/button.spec.ts', title: 'Button loading state renders correctly', declLine: decl(BUTTON_SPEC, 'Button loading state renders correctly'), declColumn: 3 },
      { file: 'tests/ui/modal.spec.ts', title: 'Modal opens and closes correctly', declLine: decl(MODAL_SPEC, 'Modal opens and closes correctly'), declColumn: 3 },
      { file: 'tests/ui/modal.spec.ts', title: 'Modal with large content scrolls correctly', declLine: decl(MODAL_SPEC, 'Modal with large content scrolls correctly'), declColumn: 3 },
    ...
    browsers: [
      ...
      { projectName: 'Chromium', browserName: 'chromium', channel: null, viewport: { width: 1280, height: 720 }, deviceScaleFactor: 2, isMobile: false, hasTouch: false, locale: 'en-US', timezoneId: 'UTC', colorScheme: 'light', reducedMotion: 'reduce' },
    ],
    browserRotation: [0],
    network: [
      { method: 'GET', url: 'https://design.example.com/components/button', status: 200, duration: 45, resourceType: 'document', contentType: 'text/html' },
      { method: 'GET', url: 'https://design.example.com/assets/tokens-D2mXq.css', status: 200, duration: 18, resourceType: 'stylesheet', contentType: 'text/css' },
      { method: 'GET', url: 'https://design.example.com/assets/components-Bq7Yz.js', status: 200, duration: 52, resourceType: 'script', contentType: 'text/javascript' },
      { method: 'GET', url: 'https://design.example.com/fonts/Inter-Variable.woff2', status: 200, duration: 33, resourceType: 'font', contentType: 'font/woff2' },
    ],
    consolePassing: [
      { type: 'warning', text: '[Vue warn]: Extraneous non-props attributes (variant) were passed to component', location: 'https://design.example.com/assets/components-Bq7Yz.js:1:8412' },
    ],
    webVitals: true,
    pageState: {
  ...
  },
  {
    ...
    cases: [
      { file: 'tests/mobile/navigation.spec.ts', title: 'Tab bar navigation works correctly', declLine: decl(MOBILE_NAV_SPEC, 'Tab bar navigation works correctly'), declColumn: 3 },
      { file: 'tests/mobile/navigation.spec.ts', title: 'Back gesture navigates correctly', declLine: decl(MOBILE_NAV_SPEC, 'Back gesture navigates correctly'), declColumn: 3 },
      ...
      { file: 'tests/mobile/forms.spec.ts', title: 'Text input shows keyboard on focus', declLine: decl(MOBILE_FORMS_SPEC, 'Text input shows keyboard on focus'), declColumn: 3 },
      { file: 'tests/mobile/forms.spec.ts', title: 'Date picker works correctly', declLine: decl(MOBILE_FORMS_SPEC, 'Date picker works correctly'), declColumn: 3 },
    ...
    browsers: [
      ...
      { projectName: 'Mobile Safari', browserName: 'webkit', channel: null, viewport: { width: 390, height: 664 }, deviceScaleFactor: 3, isMobile: true, hasTouch: true, locale: 'en-GB', timezoneId: 'Europe/London', colorScheme: 'light', userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.4 Mobile/15E148 Safari/604.1' },
    ],
    browserRotation: [0],
    network: [
      { method: 'GET', url: 'https://m.shop.example.com/', status: 200, duration: 480, resourceType: 'document', contentType: 'text/html' },
      { method: 'GET', url: 'https://m.shop.example.com/hero-4k.png', status: 200, duration: 3400, resourceType: 'image', contentType: 'image/png' },
      { method: 'GET', url: 'https://m.shop.example.com/api/products/featured', status: 200, duration: 190, resourceType: 'fetch' },
    ],
    consolePassing: null,
    webVitals: true,
    pageState: {
  ...
  },
  {
    ...
    cases: [
      { file: 'tests/admin/login.spec.ts', title: 'signs in with SSO redirect', declLine: decl(LOGIN_SPEC, 'signs in with SSO redirect'), declColumn: 3 },
      { file: 'tests/admin/login.spec.ts', title: 'shows an error for a revoked account', declLine: decl(LOGIN_SPEC, 'shows an error for a revoked account'), declColumn: 3 },
      { file: 'tests/admin/users.spec.ts', title: 'Users table paginates 25 rows per page', declLine: decl(USERS_SPEC, 'Users table paginates 25 rows per page'), declColumn: 3 },
      { file: 'tests/admin/users.spec.ts', title: 'invites a user by email', declLine: decl(USERS_SPEC, 'invites a user by email'), declColumn: 3 },
      { file: 'tests/admin/users.spec.ts', title: 'filters users by role', declLine: decl(USERS_SPEC, 'filters users by role'), declColumn: 3 },
      { file: 'tests/admin/reports.spec.ts', title: 'renders the revenue chart', declLine: decl(REPORTS_SPEC, 'renders the revenue chart'), declColumn: 3 },
      { file: 'tests/admin/reports.spec.ts', title: 'exports the monthly report as CSV', declLine: decl(REPORTS_SPEC, 'exports the monthly report as CSV'), declColumn: 3 },
      { file: 'tests/admin/settings.spec.ts', title: 'updates the organization name', declLine: decl(SETTINGS_SPEC, 'updates the organization name'), declColumn: 3 },
      { file: 'tests/admin/settings.spec.ts', title: 'rotates the API token', declLine: decl(SETTINGS_SPEC, 'rotates the API token'), declColumn: 3 },
      { file: 'tests/admin/settings.spec.ts', title: 'toggles dark mode', declLine: decl(SETTINGS_SPEC, 'toggles dark mode'), declColumn: 3 },
    ],
    suites: {
    ...
    browsers: [
      { projectName: 'Chromium', browserName: 'chromium', channel: null, viewport: { width: 1440, height: 900 }, ...DESKTOP, locale: 'en-US', timezoneId: 'UTC', colorScheme: 'light' },
      { projectName: 'Firefox', browserName: 'firefox', channel: null, viewport: { width: 1440, height: 900 }, ...DESKTOP, locale: 'en-US', timezoneId: 'UTC', colorScheme: 'light' },
      { projectName: 'WebKit', browserName: 'webkit', channel: null, viewport: { width: 1440, height: 900 }, ...DESKTOP, locale: 'en-US', timezoneId: 'UTC', colorScheme: 'light' },
      ...
      { projectName: 'Chromium', browserName: 'chromium', channel: null, viewport: { width: 1440, height: 900 }, ...DESKTOP, locale: 'en-US', timezoneId: 'UTC', colorScheme: 'dark' },
    ],
    browserRotation: [3, 3, 1, 2, 0, 1, 0, 2, 0, 0],
    network: [
      { method: 'GET', url: 'https://admin.example.com/api/metrics?range=30d', status: 200, duration: 210, resourceType: 'fetch' },
      { method: 'GET', url: 'https://admin.example.com/api/users?page=1', status: 200, duration: 160, resourceType: 'fetch' },
      { method: 'GET', url: 'https://admin.example.com/api/orgs/current', status: 200, duration: 55, resourceType: 'fetch' },
    ],
    consolePassing: [
      { type: 'log', text: '[telemetry] session started (sampled)', location: 'https://admin.example.com/assets/app-Cw1pR7.js:4:1022' },
    ],
    webVitals: true,
    pageState: {
      ...
      cookies: [{ name: 'admin_session', domain: 'admin.example.com', path: '/', httpOnly: true, secure: true, sameSite: 'Strict' }],
    },
    stepTitles: [
