/**
 * Generates docs/configuration.md — the configuration reference page — from
 * the typed env-var registry (application/shared/piwi-env-vars.ts).
 *
...
<!-- Source of truth: application/shared/piwi-env-vars.ts, rendered by docs/scripts/generate-configuration.mjs (npm run docs:gen). -->
...
console.log(`generated docs/configuration.md from ${varNames.length} registry entries (v${appVersion})`);
